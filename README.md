# **Maze-Runner**
_Maze Runner is an assembly-based game created with NASM, featuring challenging hardcoded mazes, dynamic obstacles, and rewarding collectibles that test a player's strategy and reflexes._
